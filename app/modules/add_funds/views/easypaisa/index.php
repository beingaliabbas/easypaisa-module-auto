    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="form-group text-center">
          <img src="/assets/images/payments/easypaise.png" alt="EasyPaisa Logo" style="width: 50%;">
          <p class="p-t-10"><small><?=sprintf(lang("you_can_deposit_funds_with_paypal_they_will_be_automaticly_added_into_your_account"), 'EasyPaisa')?></small></p>
        </div>
